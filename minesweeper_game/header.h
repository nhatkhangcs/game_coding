...
{
    // Take the input move
    printf("Choose a point (input coordinate with the format <row column>) -> ");
    scanf("%d %d", x, y);
    return;
}
...
void chooseDifficultyLevel ()
{
    ...
    */
    ...
    int level;
 	...
 	cout << "                    REMADE BY: NHAT KHANG"                    << "\n"; 
    printf ("                 DIFFICULTY LEVELS AS FOLLOW                     \n");
    printf ("Press 0 for BEGINNER          ||      (9  * 9  BOARD and 10 MINES)   \n");
    printf ("Press 1 for INTERMEDIATE      ||      (16 * 16 BOARD and 40 MINES)    \n");
    printf ("Press 2 for ADVANCED          ||      (24 * 24 BOARD and 99 MINES) \n");
    cout << "\n";
 	printf ("What is your chosen DIFFICULTY? -> ");
    scanf ("%d", &level);
